...
│   ├── main.js                  # Wallpaper background video loader
│   ├── widgets.js               # Widget iframe loader
│   ├── style.css                # Main stylesheet
│   │
│   ├── 📁 wallpaper_selector/   # Wallpaper selection UI
│   │   ├── index.html           # Wallpaper grid/list interface
│   │   ├── main.js              # Wallpaper browser logic
│   │   └── style.css            # Wallpaper selector styling
│   │
│   └── 📁 widget_center/        # Widget configuration UI
│       ├── index.html           # Widget manager interface
│       ├── widget_center.js     # Widget positioning and config
│       └── style.css            # Widget center styling
│
├── 📁 examples/                 # Example content for users
│   ├── 📁 widgets/              # Example widget templates
│   │   ├── 📁 clock/            # Clock widget example
│   │   │   ├── widget.html      
│   │   │   ├── widget.css       
│   │   │   └── widget.js        
│   │   │
│   │   ├── 📁 quote/            # Quote widget example
│   │   │   ├── widget.html
│   │   │   ├── widget.css
│   │   │   └── widget.js
│   │   │
│   │   ├── 📁 status/           # System status widget example
│   │   │   ├── widget.html
│   │   │   ├── widget.css
│   │   │   └── widget.js
│   │   │
│   │   └── 📁 sample/           # Minimal widget template
│   │       ├── widget.html
│   │       ├── widget.css
│   │       └── widget.js
│   │
...
│   │
│   └── 📁 widget_development/   # Widget creation guide
│       ├── README.md            # Widget development guide
│       ├── STRUCTURE.md         # Widget file structure
│       ├── BEST_PRACTICES.md    # Widget best practices
│       ├── STYLING.md           # CSS and responsive design
│       └── EXAMPLES.md          # Widget code examples
│
├── 📁 main.build/               # Build intermediates (generated by build process)
│
├── 📁 main.dist/                # Distribution files (generated by build process)
│
...
├── Contents/
│   ├── MacOS/
│   │   └── MyLiveWallpaper       # Compiled executable
│   ├── Resources/
│   │   ├── web/                  # Web files (included)
│   │   ├── examples/             # Examples (included)
│   │   └── MyLiveWallpaper.icns  # Application icon
